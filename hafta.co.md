...
*   Support provided as follows:
    ...
    According to the purchased plan, you can have email support.

## Intro.js - Terms and conditions

1.  **Preamble:** This Agreement, signed on May 29 2017 (hereinafter: Effective Date) governs the relationship between www.hafta.co (hereinafter: Licensee) and Afshin Mehrabani, a private person whose principal place of business is 46 Old kilmainham village, bow lane west, Dublin 8 (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Intro.js (hereinafter: The Software) created and owned by Licensor, as detailed herein

2.  **License Grant:** Licensor hereby grants Licensee a Personal, Non-assignable & non-transferable, Pepetual, Commercial with terms, Including the rights to create but not distribute derivative works, Non-exclusive license, all with accordance with the terms set forth and other legal restrictions set forth in 3rd party software used while running Software.
